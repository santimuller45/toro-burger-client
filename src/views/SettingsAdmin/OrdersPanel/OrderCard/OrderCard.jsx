...
const OrderCard = ( order ) => {
    ...
    const { id ,foodOrder ,totalAmount, orderStatus ,updated, paymenType, comentary , userEmail, userFirstname, userLastname } = order;

    return ( 
    <div>
        <Card key={id} className={style.card}>
            <Card.Body>
                <Card.Title><strong>Pedido N° {id}</strong></Card.Title>
