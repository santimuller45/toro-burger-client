...
const ListInProcessOrders = () => {

    const processOrders = useSelector(state => state.ordersInProcess);

    return (
        <div className="container-fluid col-8 mt-3">
            <h3><strong>PEDIDOS EN PROCESO</strong></h3>
...
export default ListInProcessOrders;